...
var accordions = footer.querySelectorAll('[data-accordion-block]'); // Функция закрытия других аккордеонов при открытии одного
...
var aboutButton = about.querySelector('#about__button'); // Элемент с дополнительной информацией

var aboutMoreInfo = about.querySelector('#about__more-info');
