...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_phone_input_mask_js__WEBPACK_IMPORTED_MODULE_4__["checkInputPhoneField"])();
...
if (callbackModal) {
  ...
  var closeModalCallback = function closeModalCallback() {
    ...
    document.removeEventListener('key', onModalCallbackEsc); // Удалили обработчик на закрытие по клику вне модального окна
...
/*!********************************!*\
  !*** ./js/phone-input-mask.js ***!
  \********************************/
/*! exports provided: checkInputPhoneField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkInputPhoneField", function() { return checkInputPhoneField; });
// https://web-revenue.ru/verstka/maska-vvoda-telefona-v-input-na-js
var inputPhoneField = document.querySelector('[data-input-phone]');

var checkInputPhoneField = function checkInputPhoneField() {
  if (inputPhoneField) {
