...
var moreInfo = about.querySelector('#more-info');
...
var onPhonePaste = function onPhonePaste(e) {
  ...
  var pasted = e.clipboardData || window.Clipboard;
...
var onPhoneInput = function onPhoneInput(e) {
  var input = e.target; // Положение курсора
...
var onPhoneKeyDown = function onPhoneKeyDown(e) {
  var inputValue = e.target.value.replace(regExp, '');
