...
var orderСallButton = header.querySelector('#header__button'); // Модальное окно с формой для обратной связи

var callbackModal = pageBody.querySelector('#callback-modal');
...
if (callbackModal) {
  ...
  var closeModalCallback = function closeModalCallback() {
    ...
    callbackModal.classList.remove('show'); // Удалили обработчик на закрытие по крестику
  ...
  var callbackModalBtnClose = callbackModal.querySelector('#callback-modal__btn-close'); // Поле для ввода имени в модальном окне или просто первое поле ввода данных

  var firstInputOnModal = callbackModal.querySelector('input');
  ...
  var onModalCallbackOpen = function onModalCallbackOpen(evt) {
    ...
    firstInputOnModal.focus(); // Добавили обработчик на закрытие по нажатию на крестик
